...
const OfficerCard = (props) => {
  const cardInfo = [
    ...
    {image: kevin, title: "Kevin Ziebarth", subtitle: "Vice-President", text: "Kevin Ziebarth is a Junior Computer Science Major.He is currently a tutor with the Computer Science Department as Southeastern Louisiana University. Along with being a Peer assistant learning(PAL) who helps teach a software development class.  Outside of school He enjoys soccer, time with friends and family, working out, cooking, video games, swimming, learning new things and coding of course."},
