        ...
        <>
          {
            officers.map((officer) => (
              <Card key = {officer.user.id} className= "box">
              <CardImg className="cImage" variant = "top" src={officer.content.photo}/>
              <CardBody className="cBody">
              <CardTitle className="cTitle" tag="h5">{officer.content.position}</CardTitle>
              <CardText className="cText">{officer.content.text}</CardText>
